  ...
  <div class="home_field">
    <div class="columns">
      ...
      <div class="top-right-item">
        ...
        <button
          class="button create-button save- is-success"
          :class="loading"
          @click="save"
          v-if="!edit"
        >
    ...
    >
      <quill-editor
        ...
        name="address"
        v-validate="'required'"
        v-model="value.attributes.contact.address"
      />
    </b-field>
    ...
    >
      <b-input
        v-model="value.attributes.contact.email"
        expanded
        :disabled="edit"
        name="email"
        placeholder="Email"
    ...
    <b-field
      label="Telephone"
      custom-class="is-small"
      :type="errors.has('telephone') ? 'is-danger' : ''"
      :message="errors.first('telephone')"
    >
      <b-input
        v-model="value.attributes.contact.telephone"
        expanded
        :disabled="edit"
        name="telephone"
...
export default {
  ...
  async asyncData({ store }) {
    ...
    if (!_.isNil(pageId)) {
      ...
      await store.dispatch("pages/getPage", 3);
    }
  ...
  methods: {
    ...
    async save() {
      ...
      if (result) {
        ...
        if (res) {
          this.$buefy.snackbar.open({
            message: "Successfully Edited Contact Page.",
            type: "is-success",
            position: "is-top",
          });
          this.loading = "";
